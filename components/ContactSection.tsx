  ...
  return (
    <MotionSection id="contact" className="section-shell scroll-mt-24 py-20">
      <div className="relative overflow-hidden border-[3px] border-ink bg-blush p-6 sm:p-10">
        ...
        <div className="relative mt-10 border-t border-ink/50 pt-6 text-sm font-black uppercase tracking-[0.16em] text-ink/70">Stephanie Ponce • Makeup • DIY • Baking • {siteContent.handle}</div>
      </div>
    </MotionSection>
  );
}
