  ...
  return (
    <section id="home" className="section-shell grid items-center gap-12 pb-16 pt-28 lg:min-h-screen lg:grid-cols-[1.05fr_0.95fr] lg:pt-24">
      <motion.div variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.1, delayChildren: 0.06 } } }} initial="hidden" animate="visible" className="relative">
        ...
        <motion.h1 variants={fadeUp} transition={{ duration: 0.72, ease: [0.22, 1, 0.36, 1] }} className="max-w-4xl font-display text-[clamp(4.5rem,14vw,8.9rem)] leading-[0.86] tracking-normal">Stephanie Ponce</motion.h1>
        ...
        <motion.div variants={fadeUp} transition={{ duration: 0.64, ease: [0.22, 1, 0.36, 1] }} className="mt-9 flex flex-col gap-3 sm:flex-row">
          <a href="#gallery" className="focus-ring inline-flex items-center justify-center gap-3 border border-ink bg-ink px-6 py-3 text-sm font-black uppercase tracking-[0.13em] text-powder transition duration-200 hover:bg-cherry"><Images size={18} />View Gallery</a>
